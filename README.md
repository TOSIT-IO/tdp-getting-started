...
# TL;DR
```bash
ansible-playbook deploy-all.yml deploy-hdfs-yarn-mapreduce.yml deploy-users.yml deploy-postgres.yml deploy-ranger.yml deploy-hive.yml deploy-ranger-user-policy.yml deploy-spark.yml -K
```
